package com.leightek.kafka;

import com.leightek.kafka.domain.Greeting;
...
public class SpringKafkaApplication {
	...
	public static void main(String[] args) throws Exception {
		...
		producer.sendMessageToFiltered("Hello Leightek!");
		producer.sendMessageToFiltered("Hello World!");
		listener.filterLatch.await(10, TimeUnit.SECONDS);

		producer.sendGreetingMessage(new Greeting("Greeting", "World!"));
	...
	public static class MessageListener {
		...
		public void greetingListenr(Greeting greeting) {
