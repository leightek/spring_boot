package com.leightek.todo.client;

import com.leightek.todo.client.domain.ToDo;
import com.leightek.todo.client.error.ToDoErrorHandler;
...
public class ToDoRestClient {
    ...
    ToDoRestClient(ToDoRestClientProperties properties) {
    ...
    public ToDo setCompleted(String id) throws URISyntaxException {
        ...
        restTemplate.postForObject(properties.getUrl() + properties.getBasePath() + "/{id}?_method=patch",
                null, ResponseEntity.class, params); // TODO: getting 405 METHOD_NOT_ALLOWED
