package com.leightek.user.config;

import com.leightek.user.domain.User;
import com.leightek.user.repository.UserRepository;
...
public class UserConfig {
    ...
    @Bean
    public LocalContainerEntityManagerFactoryBean userEntityManager(JpaProperties userJpaProperties) {
    ...
    private EntityManagerFactoryBuilder createEntityManagerFactoryBuilder(JpaProperties userJpaProperties) {
        ...
        return new EntityManagerFactoryBuilder(jpaVendorAdapter, userJpaProperties.getProperties(),
