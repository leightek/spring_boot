...
public class ToDoConfig {
    ...
    @Bean
    public LocalContainerEntityManagerFactoryBean todoEntityManager(JpaProperties todoJpaProperties) {
    ...
    @Bean
    @Primary
    public JpaTransactionManager todoTransactionManager(EntityManagerFactory todoEntityManager) {
        return new JpaTransactionManager(todoEntityManager);
    }

    private EntityManagerFactoryBuilder createEntityManagerFactoryBuilder(JpaProperties todoJpaProperties) {
        JpaVendorAdapter jpaVendorAdapter = createJpaVendorAdapter(todoJpaProperties);
        return new EntityManagerFactoryBuilder(jpaVendorAdapter, todoJpaProperties.getProperties(),
